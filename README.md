...
```markdown
python3 train_wrn_ebm.py --lr .0003 --dataset MNIST --optimizer adam --p_x_weight 1.0 --p_y_given_x_weight 1.0 --p_x_y_weight 0.0 --sigma .03 --width 10 --depth 28 --save_dir /home/geraldkwhite/JEM/data --plot_uncond --warmup_iters 1000 --n_epochs 20 --n_steps=20
```
